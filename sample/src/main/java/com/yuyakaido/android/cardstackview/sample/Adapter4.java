...
public class Adapter4 extends RecyclerView.Adapter<Adapter4.MyViewHolder> {
    ...
    public Adapter4(List<ThreadDataModel3> dataList, Context context) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (position != RecyclerView.NO_POSITION) {
                        ...
                        // 画面遷移のためのIntentを作成
                        Intent intent = new Intent(context,CommentActivity4.class); // 遷移先のActivityを指定
                        ...
                        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Thread/Comment_bar4");
            ...
            button_get.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (buttonText.equals("✌")) {
                        ...
                        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Chat/List2").child(gmail);
