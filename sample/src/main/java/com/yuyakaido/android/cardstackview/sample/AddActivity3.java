...
public class AddActivity3 extends AppCompatActivity {
    ...
    private String name_database,grade_database,department_database,subject_database,age,button;
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if ( editText3.length() > 0) {
                    ...
                    DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Thread/Page3");

                    // 新しいデータオブジェクトを作成
                    ThreadDataModel3 data = new ThreadDataModel3(text1, text2, text3, timestamp,text4,text5,text6);
