...
public class CommentActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CommentActivity2.this, AddCommentActivity2.class);
    ...
    private void readDataFromFirebase() {
        ...
        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("Thread/Comment_bar2").child(number);
        // データの変更を監視
