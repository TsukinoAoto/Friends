...
public class CommentActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(CommentActivity3.this, AddCommentActivity3.class);
    ...
    private void readDataFromFirebase() {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReference("Thread/Comment3").child(number);
        ...
        DatabaseReference databaseReference1 = FirebaseDatabase.getInstance().getReference("Thread/Comment_bar3").child(number);
        // データの変更を監視
